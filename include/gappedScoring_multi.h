...
#ifndef _gappedScoring_multi_
#define _gappedScoring_multi_

// Perform gapped alinment with restricted insertion
int4 gappedScoring_score_multi(struct ungappedExtension* ungappedExtension, struct PSSMatrix PSSMatrix,
