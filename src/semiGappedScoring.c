...
struct dpResults semiGappedScoring_dpBeforeSeed(unsigned char *subject,
                                                ...
                                                int4 dropoff);
struct dpResults semiGappedScoring_dpAfterSeed(unsigned char *subject,
                                               struct PSSMatrix PSSMatrix,
                                               int4 dropoff,
                                               int4 subjectLength);
...
int4 semiGappedScoring_score(struct ungappedExtension *ungappedExtension,
  ...
  beforeDpResults = semiGappedScoring_dpBeforeSeed(
  ...
  afterDpResults = semiGappedScoring_dpAfterSeed(
