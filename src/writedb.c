...
char *writedb_sequenceFilename, *writedb_descriptionsFilename,
    *writedb_dataFilename;
uint4 writedb_maximumSequenceLength, writedb_alphabetType,
    writedb_minimumSequenceLength;
...
// Add sequence to the formatted collection
void writedb_addSequence(unsigned char *sequence, uint4 sequenceLength,
                         unsigned char *description, uint4 descriptionLength,
                         unsigned char *wildcards, uint4 wildcardsLength,
  ...
  sequenceData->sequenceLength = sequenceLength;
  sequenceData->encodedLength = encodedLength + wildcardsLength;
  sequenceData->oid = writedb_sequenceCount;
