...
```
* 2 Sort FASTA database by sequence length (take a while for large database, may use another fasta sort tool, e.g., https://github.com/jimhester/fasta_utilities)
```
